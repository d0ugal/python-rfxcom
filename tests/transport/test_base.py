...
from rfxcom.compat import mock
...
class BaseTransportTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.device = mock.Mock(spec=Serial)
    ...
    def test_setup_callbacks_single(self):
        ...
        self.assertEqual(self.transport.default_callback, _callback)
    ...
    def test_setup_callbacks_mutli(self):
        ...
        self.assertEqual(parser.default_callback, _callback)
        self.assertEqual(parser.callbacks, {
            Elec: _callback2
        })
    ...
    def test_log(self):
        ...
        self.assertEqual(self.transport.log.name,
